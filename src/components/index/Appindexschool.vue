    ...
    <el-aside width="200px" class="el-aside" >
      ...
      <el-menu
        ...
        <el-submenu index="1">
          ...
          <el-menu-item-group>
            <el-menu-item index="/ActivityAddSch">活动添加</el-menu-item>
            <el-menu-item index="/ActivityListSch">活动列表</el-menu-item>
          </el-menu-item-group>
        </el-submenu>
        <el-submenu index="2">
          <template slot="title">
          ...
          <el-menu-item-group>
            <el-menu-item index="/waitAuditSch">待审核</el-menu-item>
            <el-menu-item index="/auditListSch">审核列表</el-menu-item>
          </el-menu-item-group>
        </el-submenu>
        <el-menu-item index="/feedbackSch">
        ...
        <el-menu-item index="/modifyUserSch">
          <i class="el-icon-setting"></i>
